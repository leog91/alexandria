...
type ToolTag = "react" | "db" | "terminal" | "test" | "node"
...
export const tools: Tool[] = [
    ...
    { name: "picocolors", description: "The tiniest and the fastest library for terminal output formatting with ANSI colors", uri: "https://github.com/alexeyraspopov/picocolors", tags: ["terminal", "test"] },
